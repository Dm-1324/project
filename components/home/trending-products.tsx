...
const trendingProducts = {
  ...
  "Fashion": [
    ...
    },
    {
      ...
      price: 34.99,
      image: "https://images.pexels.com/photos/5709665/pexels-photo-5709665.jpeg?auto=compress&cs=tinysrgb&w=1600",
      category: "Fashion",
      creator: {
        name: "Sophia Chen",
        handle: "sophiadesigns",
  ...
  "Tech": [
    ...
    },
    {
      ...
      price: 89.99,
      image: "https://images.pexels.com/photos/4047971/pexels-photo-4047971.jpeg?auto=compress&cs=tinysrgb&w=1600",
      category: "Tech",
      creator: {
        name: "Alex Rivera",
        handle: "techwithalex",
  ...
  "Lifestyle": [
    ...
    },
    {
      ...
      price: 39.99,
      image: "https://images.pexels.com/photos/3690502/pexels-photo-3690502.jpeg?auto=compress&cs=tinysrgb&w=1600",
      category: "Lifestyle",
      creator: {
        name: "Emma Lewis",
        handle: "emmacreates",
  ...
  return (
    <Tabs defaultValue="All" onValueChange={setActiveCategory}>
      <div className="flex justify-between items-center mb-8">
        <TabsList className="bg-muted/50 h-auto p-1.5 space-x-2">
          {categories.map(category => (
            <TabsTrigger 
              ...
              className={cn(
                ...
                "data-[state=active]:shadow-sm transition-all text-base"
              )}
            >
              {category}
            </TabsTrigger>
        ...
        <Link href={`/trending/${activeCategory.toLowerCase()}`} className="hidden md:flex items-center text-base text-muted-foreground hover:text-primary transition-colors">
      ...
      {categories.map(category => (
        <TabsContent key={category} value={category} className="m-0">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {trendingProducts[category as keyof typeof trendingProducts].map(product => (
              <Card
                key={product.id}
                ...
                <CardContent className="p-0">
                  <Link href={`/products/${product.id}`} className="block">
                    <div className="relative aspect-square bg-muted overflow-hidden">
                      ...
                      >
                        <Link href={`/categories/${product.category.toLowerCase()}`} className="hover:underline">
                          {product.category}
                        </Link>
                      </Badge>
                      ...
                      <div className={cn(
                        ...
                        <Button size="icon" variant="secondary" className="rounded-full shadow-sm mr-2 h-12 w-12">
                          <Heart className="h-5 w-5" />
                        </Button>
                        <Button size="icon" variant="default" className="rounded-full shadow-sm h-12 w-12">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center mt-2 mb-4">
                      <div className="flex items-center">
                        ...
                        <span className="ml-1.5 text-base font-medium">{product.rating}</span>
                      </div>
                      <span className="mx-2 text-muted-foreground">•</span>
                      <span className="text-base text-muted-foreground">{product.reviewCount} reviews</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href={`/creators/${product.creator.handle}`} className="relative flex items-center">
